...
const Footer = () => {
  ...
  return (
    <footer className="bg-text text-white pt-16 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <Link to="/" className="inline-block mb-4">
              ...
              {/*
                🔧 LOGO SIZE CONTROL
                - Increase size: h-24 md:h-32
                - Reduce size:   h-16 md:h-24
                - Keep w-auto & object-contain to avoid distortion
              */}
            </Link>

            {/* ✅ Paragraph write-up (RESTORED) */}
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/profile.php?id=61587318844186" className="text-gray-300 hover:text-primary-500 transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>

              {/* <a href="dolulogistics" className="text-gray-300 hover:text-primary-500 transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.instagram.com/dolulogistics/" className="text-gray-300 hover:text-primary-500 transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
